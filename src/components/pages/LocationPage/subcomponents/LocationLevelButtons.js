    ...
    return (
      <div className="LocationLevelButtons">
        ...
        <DropdownButton title={dropDownValue}>
          <Dropdown.Item onClick={() => this.changeValue('State')}>State</Dropdown.Item>
          <Dropdown.Item onClick={() => this.changeValue('County')}>County</Dropdown.Item>
          <Dropdown.Item onClick={() => this.changeValue('Place')}>Place</Dropdown.Item>
        </DropdownButton>
      </div>
    )
  }
